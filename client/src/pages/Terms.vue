<template>
    <div class="px-8 py-2 text-gray-400">

        <h2>Terms and Conditions</h2>

        <p><i>Last updated: January 31, 2025</i></p>
        ...
        <ul>
            ...
            <li>
                <p><strong>Terms and Conditions</strong> (also referred as "Terms") mean these Terms and Conditions that
                    form the entire agreement between You and the Company regarding the use of the Service.</p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Website</strong> refers to sudo-dragon, accessible from <a href="http://www.sudo-dragon.com"
                        rel="external nofollow noopener" target="_blank">http://www.sudo-dragon.com</a></p>
            </li>
            <li>
        ...
        <ul>
            <li>By email: sudo-dragon@gmail.com</li>
        </ul>
    </div>
</template>
